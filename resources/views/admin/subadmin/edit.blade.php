  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        ...
        <!-- form start -->
        <form role="form" action="{{route('admin.subadmin.update',$user->id)}}" method="post">
          {{ csrf_field() }}
          <div class="box-body">
           ...
           <div class="col-lg-offset-3 col-lg-6">
             <div class="form-group">
              ...
              <input required type="text" class="form-control" id="name" value="{{$user->name}}" name="name" placeholder="Enter Name">
            </div>
