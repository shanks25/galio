  ...
  <footer>
  	<!-- footer top start -->
    <!-- footer main start -->
    <div class="footer-widget-area bg-black pt-40 pb-38 pb-sm-10">
      <div class="container">
       <div class="row">
        <div class="col-md-6 col-sm-6">
         <div class="footer-widget mb-sm-30">
          <div class="widget-title mb-10 mb-sm-6 newsletter__content">
           <h4>contact us</h4>
         </div>
         <div class="widget-body newsletter__content">
           <ul class="location">
  ...
  <div class="container">
   <div class="footer-bottom-wrap">
    <div class="copyright-text">
     <p><a target="_blank" href="{{url('/')}}">TCA</a></p>
   </div>
  ...
  <div class="modal-body">
    ...
    <div class="product-details-inner">
     ...
     <div class="pro-nav slick-padding2 slick-arrow-style_2">
      ...
      <div class="pro-nav-thumb"><img src="{{asset('assets/img/product/product-details-img5.jpg')}}" alt="" /></div>
    </div>
  </div>
  <div class="col-lg-7">
