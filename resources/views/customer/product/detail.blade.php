    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-large-slider mb-20 slick-arrow-style_2">
                                @foreach($product->productImages as $key => $proDtl)
                                <div class="pro-large-img img-zoom" id="{{++$key}}">
                                    <img src="{{asset($proDtl->path)}}" alt="" />
                                </div>
                                @endforeach

                            </div>
                            <div class="pro-nav slick-padding2 slick-arrow-style_2">
                                @foreach($product->productImages as $proDtl)
                                <div class="pro-nav-thumb"><img src="{{asset($proDtl->path)}}" alt="" /></div>
                                @endforeach
                                ...
                                <div class="tab-content reviews-tab">
                                    ...
                                    <div class="tab-pane fade" id="tab_two">
                                        <table class="table table-bordered">
                                            <tbody>
                                                @foreach($product->keyValues as $key => $keys_and_values)
                                                <tr>
                                                    <td>{{$keys_and_values->key_name}}</td>
                                                    <td>{{$keys_and_values->value_name}}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                ...
                <div class="related-products-area mt-34" style="display:none;">
